...
@patch("mercado_bitcoin.ingestors.DataIngestor.__abstractmethods__", set())
class TestIngestors:
    def test_filename_checkpoint(self, data_ingestor_fixture):
        actual = data_ingestor_fixture._filename_checkpoint
    ...
    @patch("builtins.open", new_callable=mock_open, read_data="2021-06-25")
    @patch("mercado_bitcoin.ingestors.DataIngestor._filename_checkpoint", return_value="foobar.checkpoint")    
