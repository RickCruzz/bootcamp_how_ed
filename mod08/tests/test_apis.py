...
class TestTradesApi:
    @pytest.mark.parametrize(
        ...
        [
            ("TESTE",datetime.datetime(2019, 1, 1), datetime.datetime(2019,1,2), "https://www.mercadobitcoin.net/api/TESTE/trades/1546311600/1546398000"),
            ("TESTE",datetime.datetime(2021, 6, 12), datetime.datetime(2021,6,15), "https://www.mercadobitcoin.net/api/TESTE/trades/1623466800/1623726000"),
            ("TESTE",None, None, "https://www.mercadobitcoin.net/api/TESTE/trades"),
            ("TESTE",None, datetime.datetime(2021,6,15), "https://www.mercadobitcoin.net/api/TESTE/trades"),
            ("TESTE",datetime.datetime(2021, 6, 12), None, "https://www.mercadobitcoin.net/api/TESTE/trades/1623466800"),
        ]
    ...
    def test_get_endpoint_date_from_greater_than_date_to(self):
        with pytest.raises(RuntimeError):
            TradesApi(coin="TESTE")._get_endpoint(date_from=datetime.datetime(2021, 6, 15), date_to=datetime.datetime(2021,6,12))    
